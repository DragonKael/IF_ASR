...
sustentación:
Servicios Permitidos: dns, http, mdns, ssh, dhcpv6-client.
Puertos Abiertos:
80/tcp (HTTP), 443/tcp (HTTPS).
8080/tcp (PgAdmin), 5432/tcp (PostgreSQL).
53/tcp, 53/udp, 953/tcp (BIND9/DNS).
20-21/tcp (FTP).
3000/tcp, 3001/udp (Servicios Adicionales).
Reglas Ricas (Rich Rules):
rule family="ipv4" source address="10.0.0.0/8" accept (Confianza plena en el segmento Clase A).
Forwarding & Masquerade: Activados para permitir el ruteo interno de los contenedores.
